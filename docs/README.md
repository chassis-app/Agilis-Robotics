...
| 03 | [Database Schema](03_DATABASE_SCHEMA.md) | Complete 118-entity logical model with columns, constraints, and indexes |
| 04 | [Workflows](04_WORKFLOWS.md) | All 15 end-to-end workflow definitions (WF-01 to WF-15) |
